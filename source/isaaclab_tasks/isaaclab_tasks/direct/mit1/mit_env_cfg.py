...
class EventCfg:
    ...
    reset_base = EventTerm(
        ...
        mode="reset",
        params={  #roll 侧躺
            #"pose_range": {"x": (-0.0, 0.0), "y": (-0.0, 0.0), "yaw": (-3, 3),"roll" : (-3.4, 3.4),"pitch" : (-0, 0)},
...
class MitFlatEnvCfg(DirectRLEnvCfg):
    ...
    feet_air_time_reward_scale = 3
    undesired_contact_reward_scale = -1
    flat_orientation_reward_scale = -0
    joint_vel_reward_scale = -2e-3
    upward_reward_scale: float = 3
