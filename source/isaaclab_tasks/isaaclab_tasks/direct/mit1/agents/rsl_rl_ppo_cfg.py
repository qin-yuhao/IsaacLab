...
class MitFlatPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    ...
    save_interval = 500
    experiment_name = "Mitv1_flat_direct"
    empirical_normalization = False
    # policy = RslRlPpoActorCriticCfg(
    #     init_noise_std=1.0,
    #     actor_hidden_dims=[128, 128, 128,128, 128, 128],
    #     critic_hidden_dims=[128, 128, 128,128, 128, 128],
    #     activation="elu",
    # )
...
class MitRoughPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    ...
    max_iterations = 15000
    save_interval = 50
    experiment_name = "Mitv1_rough_direct"
    empirical_normalization = False
    policy = RslRlPpoActorCriticCfg(
        init_noise_std=1.0,
        actor_hidden_dims=[512, 256, 128],
