...
# Pre-defined configs
##
from isaaclab_assets.robots.big_dog import Big_CFG  # isort: skip
...
class EventCfg:
    ...
    #     mode="interval",
    #     interval_range_s=(5, 15.0),
    #     params={"velocity_range": {"x": (-1, 1), "y": (-1, 1),"z": (-0.3, 0.3),"roll": (-1, 1),"pitch": (-1,1), "yaw": (-1, 1)}}, #
    # )
...
class BigFlatEnvCfg(DirectRLEnvCfg):
    ...
    # robot
    robot: ArticulationCfg = Big_CFG.replace(prim_path="/World/envs/env_.*/Robot")
...
@configclass
class BigRoughEnvCfg(BigFlatEnvCfg):
    # env
    ...
    #     pattern_cfg=patterns.PinholeLidarPatternCfg(
    #         vertical_channels=8,           # 16线激光雷达
    #         horizontal_channels=8,        # 水平128个点
