...
class MitFlatPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    ...
    save_interval = 50
    experiment_name = "Mdog2_flat_direct"
    ...
    #     init_noise_std=1.0,
    #     actor_hidden_dims=[128,128,128,128,128,128,128,128,128,128,128,128,],
    #     critic_hidden_dims=[128,128,128,128,128,128,128,128,128,128,128,128,],
    #     activation="elu",
    # )
...
class MitRoughPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    ...
    save_interval = 50
    experiment_name = "Mdog2_rough_direct"
    empirical_normalization = False
