...
class EventCfg:
    ...
    randomize_rigid_body_inertia = EventTerm(
        ...
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names=".*"),
            "inertia_distribution_params": (0.3, 1.5),
            "operation": "scale",
        },
    )
...
class MitFlatEnvCfg(DirectRLEnvCfg):
    ...
    action_scale = [0.88* scale for  scale in action_scale]
    #action_scale = [0.1 for _ in range(12)]
    action_space = 12
    observation_space = 49 #+64
    state_space = 0
